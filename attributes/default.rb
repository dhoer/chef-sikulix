...
default['sikulix']['option']['ide_scripting']['jython'] = false # default (1.1)
...
# other IDE's
default['sikulix']['option']['java_api'] = true # (2)
...
# With this option not selected, the setup process will only add system specific native stuff
...
default['sikulix']['option']['remote_server'] = false # (5)
